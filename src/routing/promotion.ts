...
function renderModule(
  ...
  return `// SPDX-FileCopyrightText: 2026 Fulmetry contributors\n// SPDX-License-Identifier: MIT\n// Generated by fulmetry route promote. Review this authored copper before production.\nimport { defineRoutes } from "fulmetry";\n\nexport const ${exportName} = defineRoutes(${body});\n`;
}
...
export function renderPromotedRouteSourceSet(
  ...
  const indexSource = `// SPDX-FileCopyrightText: 2026 Fulmetry contributors\n// SPDX-License-Identifier: MIT\n// Generated by fulmetry route promote. Review this authored copper before production.\n${imports}\n\nexport const authoredPcbRoutes = [\n${spreads}\n] as const;\n`;
