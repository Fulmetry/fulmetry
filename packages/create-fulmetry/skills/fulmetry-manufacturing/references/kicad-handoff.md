...
After manual KiCad changes, the KiCad files are a separate source branch of the design unless a future reviewed import path proves otherwise. Do not claim those edits automatically changed the Fulmetry TypeScript source.
