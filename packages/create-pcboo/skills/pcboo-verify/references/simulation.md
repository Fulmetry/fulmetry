...
PCBoo qualifies the captured ngspice executable before using it for a passing result. Missing tools, failed qualification, absent trusted models, incomplete regions, or unsupported containment remain `unavailable` or `incomplete`.
